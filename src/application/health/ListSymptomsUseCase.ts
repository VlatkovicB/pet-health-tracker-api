...
export class ListSymptomsUseCase {
  ...
  async execute(petId: string, requestingUserId: string, pagination: PaginationParams): Promise<PaginatedResult<Symptom>> {
    ...
    return this.healthRepo.findSymptomsByPetId(petId, pagination);
  }
}
